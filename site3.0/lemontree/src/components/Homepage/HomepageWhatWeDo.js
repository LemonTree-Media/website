    	...
    	<div className="ml-5">
    		...
    		<p className="h2 font-weight-bold mb-5 ml-5 text-left transform" style={{backgroundColor: "#FFF9AE", width:"75%"}}>Transformation at speed</p>
    			<div className="d-flex flex-row">
    				<p className="h1 font-weight-bold mb-5 ml-5 text-left transform">9x</p><p className="mt-4 ml-3">more engagement than traditional videos</p>
    			</div>
    			<div className="d-flex flex-row">
    			...
    			<div className="d-flex flex-row">
    				<p className="h1 font-weight-bold mb-5 ml-5 text-left transform">30%</p><p className="mt-4 ml-3">cost reduction with pillar and repurposed content</p>
    			</div>
    		</div>
    		<img src={Funnel} className="img"/>
	          ...
	          best-in-class interactive media content, combining in-depth brand 
